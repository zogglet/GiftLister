                                        ...
                                        <table class="PrintPnlStyle">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:CheckBox ID="printImgs_cbx" runat="server" Text="Include Images" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Panel ID="cat_pnl" runat="server">
                                            ...
                                            <asp:GridView ID="recipients_gv" runat="server" CssClass="GVStyle" DataKeyNames="ID, CategoryID" HeaderStyle-CssClass="GVHeaderStyle" RowStyle-CssClass="GVItemStyle"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-CssClass="GVNameStyle">
                                                    
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="nameSort_lBtn" runat="server" Text="Name" OnClick="nameSortClick" />
                                                        </HeaderTemplate>
                                                            ...
                                                            <asp:Panel ID="gifts_pnl" runat="server">
                                                                ...
                                                                <asp:GridView ID="gifts_gv" runat="server" DataKeyNames="ID, RecipientID" HeaderStyle-CssClass="GVInnerHeaderStyle" RowStyle-CssClass="GVInnerItemStyle"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField ItemStyle-CssClass="GVInnerItemButtonStyle">
                                                                        
                                                                            <HeaderTemplate>
                                                                                <asp:LinkButton ID="descSort_lBtn" runat="server" Text="Description" OnClick="descSortClick" />
                                                                            </HeaderTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Complete" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Right">
                                                                            ...
                                                                            <HeaderTemplate>
                                                                                <asp:LinkButton ID="giftCompleteSort_lBtn" runat="server" Text="Complete" OnClick="giftCompleteSortClick" />
                                                                            </HeaderTemplate>
